...
const formState = ref({ email: "", username: "", password: "" });

const goSignin = () => router.push({ path: "/auth/login" });
  ...
  <div class="fcc">
    ...
    <div class="w-100">
      <div class="text-center pt-16">
        ...
        <div class="font-bold pt-2 pb-8 text-2xl">Sign up to your account</div>
      </div>
      <a-form :model="formState" layout="vertical" @finish="onFinish">
        ...
        <a-form-item>
          <div class="mx-auto my-0 text-gray-500">
            Had an account?
            <span @click="goSignin" class="font-semibold text-[#4945ff]">Sign in</span>
          </div>
        </a-form-item>
      </a-form>
    </div>
